...
// ========================
// State-by-state demographics data from the US Census
...
function visualize(theData) {
    ...
    // =================================
    // curX and curY: what data represented in each axis.
    // Designate defaults (headers).
    var curX = "poverty";
    var curY = "obesity";

    // Empty variables for our the min and max values of x and y.
    ...
    var toolTip = d3
        ...
        .html(function(d) {
            ...
            if (curX === "poverty") {
                // Grab the x key and a percentage form of the value
    ...
    // PART 2: D.R.Y!
    // ==============
    // Use functions remove some repitition from later code.
    ...
    // We append the axes in group elements (includes
    ...
    // Part 5: Responsive mobile interface
    // =========================
